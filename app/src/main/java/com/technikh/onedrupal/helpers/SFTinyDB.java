...
public class SFTinyDB {

    private SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public SFTinyDB(Context appContext) {
     ...
     * @param key SharedPreferences key defaultValue int value returned if key was not found
     ...
     * @param key SharedPreferences key defaultValue float value returned if key was not found
     ...
     * @param key SharedPreferences key defaultValue boolean value returned if key was not found
